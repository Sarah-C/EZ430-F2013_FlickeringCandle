...
//    DCOCTL=194; //Really slow < 1MHz
//    BCSCTL1=80; //Really slow

//	DCOCTL=CALDCO_16MHZ;    // (measures 1.56 MHz on the pin)      16:
//  BCSCTL1=CALBC1_16MHZ; 	//                                     16:
	
//	DCOCTL=CALDCO_12MHZ;    // (measures 1.56 MHz on the pin)      12:145
//  BCSCTL1=CALBC1_12MHZ; 	//                                     12:142
	
//	DCOCTL=CALDCO_8MHZ;    // (measures 1.56 MHz on the pin)       8:130
//  BCSCTL1=CALBC1_8MHZ;   //                                      8:141

	DCOCTL=194;//CALDCO_1MHZ;    // (measures 1.56 MHz on the pin) 1:194
    BCSCTL1=134;//CALBC1_1MHZ; 	 //                                1:134
